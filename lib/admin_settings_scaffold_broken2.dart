  ...
  Future<void> _initializeProvider() async {
    try {
      ...
      if (userSettings.settings != null) {
        ...
        _wakeWordsController.text = '${userSettings.settings!.wakeWordInterjection} ${userSettings.settings!.wakeWordName}';
                    ...
                    Consumer<UserSettingsProvider>(
                      builder: (context, userSettings, child) {
                        ...
                        return Column(
                          ...
                          children: [
                            _buildCheckbox(
                              value: userSettings.settings!.useShortSummaryOnButtons,
                              onChanged: (bool? value) {
                                if (value != null) {
                                  final settings = userSettings.settings!;
                                  settings.useShortSummaryOnButtons = value;
                            ...
                            _buildCheckbox(
                              value: userSettings.settings!.autoClean,
                              onChanged: (bool? value) {
                                if (value != null) {
                                  final settings = userSettings.settings!;
                                  settings.autoClean = value;
                                  userSettings.saveSettings(settings);
                                }
                              },
